...
class FAQChatbotAgent:
    def __init__(self):
        ...
        self.post_generator = post_data.post_generator_data # Import the post data from the provided module
    ...
    def create_vector_store(self):
        ...
        documents = []
        for key, value in self.post_generator.items():
            doc = Document(
    ...
    def answer_faq(self, question, k=3):
        ...
        message = [
            ...
            "role": "system",
            "content": (
                f"You are a professional LinkedIn post generator. "
                f"Based on this knowledge: {knowledge}\n\n"
                "Craft a concise, insightful LinkedIn post that demonstrates thought leadership, "
                "uses a professional tone, and encourages engagement. "
...
if __name__ == "__main__":
    ...
    while True:
        question = input("Give orders to your LinkedIn post generator (or type 'exit' to quit): ")
